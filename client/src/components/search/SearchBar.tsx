...
const SearchBar = () => {
  return (
    <div className='flex justify-center items-center rounded-sm p-2 flex-1 w-full'>
      <div className='bg-inherit p-1 border border-gray border-r-0 rounded-l-md min-h-11 max-w-2xl lg:w-[32rem]'>
        <input
          type='text'
          className='focus-within:bg-none focus:outline-none bg-inherit px-3 text-whiteText'
          placeholder='Search'
        />
      </div>
